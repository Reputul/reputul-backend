...
public interface WorkflowTemplateRepository extends JpaRepository<WorkflowTemplate, Long> {
     ...
     */
    List<WorkflowTemplate> findByIsSystemTemplateAndIsActiveTrueOrderByPopularityScoreDesc(Boolean isSystemTemplate);

    /**
     * Find templates by name (for uniqueness check)
     */
    List<WorkflowTemplate> findByNameContainingIgnoreCaseAndIsActiveTrue(String name);
}